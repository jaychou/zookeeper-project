...
<html lang="zh-cn">
	<head>
		<meta charset="utf-8" />
		<title>
		  <decorator:title default="首页"/>-后台管理系统 - 立阳产业
		</title>
					...
					<ul class="nav ace-nav pull-right">
						...
						<li class="light-blue">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="res/sunshine/webadmin/web/assets/avatars/user.jpg" alt="Jason's Photo" />
				  ...
				  <%--   <c:forEach var="item" items="${menus}">
					...
					<li>
						<a href="#" class="dropdown-toggle">
							...
							<span class="menu-text">Zookeeper</span>
